...
|11   |Intro to Recommendation Systems*   |<ul><li>Intro to collaborative filtering</li><ul><li>Item-based</li><li>User-based</li><li>Hybrid</li></ul><li>Intro to learning to rank</li><li>Intro to information retrieval</li></ul>  |<ul><li>What is learnt above will be applied to here</li></ul>   |
