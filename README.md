...
|11   |Intro to Recommendation Systems*   |<ul><li>Intro to collaborative filtering</li><ul><li>Item-based</li><li>User-based</li><li>Hybrid</li></ul></ul>  |<ul><li>What is learnt above will be applied to here</li></ul>   |
